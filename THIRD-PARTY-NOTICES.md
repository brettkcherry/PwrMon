...
PowerMonitor bundles or depends on the following open-source components:
...
source code is available at the repository linked above. PowerMonitor uses it as
an unmodified library dependency.

**Not bundled:** PowerMonitor can optionally download the official
...
separate product and is never redistributed inside PowerMonitor packages.
